...
print("bytearray('test') gives %s" % bytearray('test', 'utf-8'))
print("====================================")
print("callable()")
...
print("print long(444.55) gives %s" % int(444.55))
print("====================================")
print("map()")
...
print("reduce(lambda x,y:x+y,range(101)) gives %s" % reduce(lambda x,y:x+y,list(range(101))))
print("====================================")
print("reload()")
...
print("unichr(97) gives %s" % chr(97))
print("====================================")
print("unicode()")
print("Return the Unicode string version of object")
print("unicode('ggg') gives %s" % str('ggg'))
print("====================================")
print("vars()")
...
print("xrange(5,11,2) gives %s" % range(5,11,2))
print("====================================")
print("zip()")
