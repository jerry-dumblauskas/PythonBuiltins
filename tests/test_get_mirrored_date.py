from solstice_balance import _get_solstice_date, get_mirror_date
import datetime
...
class TestGet_solstice_date(TestCase):
    ...
    def test_get_solstice_date_on_solstice_day(self):
        self.assertEqual(_get_solstice_date(), datetime.date(2015, 12, 21))
    ...
    def test_get_solstice_date_after_equinox_day(self):
        self.assertEqual(_get_solstice_date(), datetime.date(2016, 6, 21) )
